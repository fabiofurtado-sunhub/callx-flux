...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  const moveLeadToStage = async (leadId: string, newStage: LeadStatus) => {
    ...
    const scoreMap: Record<LeadStatus, number> = { lead: 10, mensagem_enviada: 15, fup_1: 20, ia_call: 25, reuniao: 30, no_show: 25, reuniao_realizada: 45, proposta: 60, venda: 100, perdido: 5 };
    const probMap: Record<LeadStatus, number> = { lead: 10, mensagem_enviada: 15, fup_1: 20, ia_call: 25, reuniao: 30, no_show: 15, reuniao_realizada: 45, proposta: 60, venda: 100, perdido: 0 };
